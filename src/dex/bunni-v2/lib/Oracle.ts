...
export function grow(
  ...
  for (let i = Number(current); i < Number(next); i++) {
    // TODO CHECK
    // in the original solidity, this 'prepares' the next observation
    // not really sure what that does, but it throws off our tests
    // because the observations array is too long
