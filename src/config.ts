...
const baseConfigs: { [network: number]: BaseConfig } = {
  ...
  [Network.PLASMA]: {
    ...
    adapterAddresses: {},
    augustusRFQAddress: '0x92EaD5bACf6F0E995FA46Ad8215A9b11f67ca241',
    augustusV6Address: '0x972783B82AA3Cd67E1A6b54e4E742BBADc2F4e77',
    executorsAddresses: {
      Executor01: '0x6379E5e0908F95c59e184fBd0E2d34281150FC45',
      Executor02: '0xE48E0c96Bfa2c77eb95B6b34224c796823600E4E',
      Executor03: '0x3d7464f22F535daD8b9f8BAdCe2928c90F31b84c',
    },
    rpcPollingMaxAllowedStateDelayInBlocks: 0,
    rpcPollingBlocksBackToTriggerUpdate: 0,
    hashFlowDisabledMMs: [],
